...
class TestCalculateCredHash:
    ...
    def test_v1_uses_hmac_sha1(self) -> None:
        ...
        asyncio.run(calculate_cred_hash(user_id="test_user", H1="aa" * 16, cred=cred, hasher=hasher, kdf=kdf))

        hasher.hmac_sha1.assert_called_once()
        hasher.hmac_sha256.assert_not_called()

    def test_v2_uses_hmac_sha256(self) -> None:
    ...
    def test_v2_without_key_label_raises(self) -> None:
    ...
    def test_v1_and_v2_produce_different_hashes(self) -> None:
        ...
        h2_v1 = asyncio.run(
            calculate_cred_hash(user_id="test_user", H1="aa" * 16, cred=cred_v1, hasher=hasher, kdf=kdf)
        )
    ...
    def test_v2_uses_new_hasher(self) -> None:
    ...
    def test_v2_without_new_hasher_raises(self) -> None:
    ...
    def test_v1_ignores_new_hasher(self) -> None:
