...
def check_user_official_name(context: Context, queue_user: CleanerQueueUser, navet_data: NavetData) -> None:
    ...
    if get_official_given_name(navet_name) is None or get_official_surname(navet_name) is None:
    ...
    if user.given_name == get_official_given_name(navet_name) and user.surname == get_official_surname(navet_name):
