...
class IdPTestLogin(IdPTests):
    ...
    def test_eduperson_targeted_id(self) -> None:
        with self.app.test_request_context():
            ...
            assert attributes["eduPersonTargetedID"] == [
                "71a13b105e83aa69c31f41b08ea83694e0fae5f368d17ef18ba59e0f9e407ec9"
            ]
    ...
    def test_schac_personal_unique_code_esi(self) -> None:
        with self.app.test_request_context():
            ...
            assert attributes["eduPersonTargetedID"] == [
                "75fae1234b2e3304bfd069c1296ccd7af97f2cc95855e2e0ce3577d1f70a0088"
            ]
