...
from eduid.common.proofing_utils import get_official_surname
...
def refresh_user_data(user: User) -> FluxData:
    ...
    if not navet_data.person.name.given_name or get_official_surname(navet_data.person.name) is None:
