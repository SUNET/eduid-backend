...
from eduid.webapp.samleid.helpers import SamleidMsg, attribute_remap, create_authn_info
...
def assertion_consumer_service() -> WerkzeugResponse:
    ...
    # Remap nin in staging environment (only for eidas methods)
