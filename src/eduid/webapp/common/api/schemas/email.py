...
class LowercaseEmail(Email):
    ...
    def _serialize(self, value: str | None, attr: str | None, obj: object, **kwargs: Any) -> str | None:
        _value = super()._serialize(value, attr, obj, **kwargs)
        if _value is None:
            return None
        return _value.lower()

    def _deserialize(self, value: str | None, attr: str | None, data: Mapping[str, Any] | None, **kwargs: Any) -> str:
