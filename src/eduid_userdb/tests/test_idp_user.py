...
from eduid_userdb.idp.user import _SAML_ATTRIBUTES, IdPUser
...
class TestIdpUser(TestCase):
    def setUp(self):
        ...
        self.idp_config = {
            ...
            'default_scoped_affiliation': 'affiliate',
    ...
    def test_idp_user_to_attributes_all(self):
        ...
        attributes = idp_user.to_saml_attributes(config=self.idp_config)
        ...
        expected = {
            ...
            'eduPersonScopedAffiliation': 'affiliate',
            'c': 'se',
            'co': 'Sweden',
