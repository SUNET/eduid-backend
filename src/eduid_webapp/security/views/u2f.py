...
from eduid_webapp.security.helpers import compile_credential_list, credentials_to_registered_keys
...
def bind(user, version, registration_data, client_data, description=''):
    ...
    return {'message': 'security.u2f_register_success', 'credentials': compile_credential_list(security_user)}
...
def remove(user, credential_key):
    ...
    return {'message': 'security.u2f-token-removed', 'credentials': compile_credential_list(security_user)}
